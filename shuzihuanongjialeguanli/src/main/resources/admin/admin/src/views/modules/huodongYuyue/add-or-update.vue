    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名唯一编号" prop="huodongYuyueUuidNumber">
                       <el-input v-model="ruleForm.huodongYuyueUuidNumber"
                                 placeholder="报名唯一编号" clearable  :readonly="ro.huodongYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名唯一编号" prop="huodongYuyueUuidNumber">
                           <el-input v-model="ruleForm.huodongYuyueUuidNumber"
