                ...
                if(!".xls".equals(suffix)){
                    ...
                    if(!file.exists()){
                        ...
                        for(List<String> data:dataList){
                            //循环
                            MinsuEntity minsuEntity = new MinsuEntity();
//                            minsuEntity.setMinsuUuidNumber(data.get(0));                    //客房编号 要改的
//                            minsuEntity.setMinsuName(data.get(0));                    //客房名称 要改的
//                            minsuEntity.setMinsuPhoto("");//详情和图片
//                            minsuEntity.setMinsuTypes(Integer.valueOf(data.get(0)));   //客房类型 要改的
//                            minsuEntity.setMinsuNewMoney(data.get(0));                    //客房定金 要改的
...
//                            minsuEntity.setInsertTime(date);//时间
...
//            .notIn("minsu_types", new Integer[]{102})
            ;
        logger.info("sql语句:"+queryWrapper.getSqlSegment());
        MinsuEntity minsuEntity = minsuService.selectOne(queryWrapper);
        if(minsuEntity==null){
