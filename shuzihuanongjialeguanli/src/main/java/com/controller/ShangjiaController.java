    ...
    */
    ...
    public R save(@RequestBody ShangjiaEntity shangjia, HttpServletRequest request){
        ...
        Wrapper<ShangjiaEntity> queryWrapper = new EntityWrapper<ShangjiaEntity>()
            ...
            .or()
            .eq("shangjia_id_number", shangjia.getShangjiaIdNumber())
...
//                            shangjiaEntity.setShangjiaName(data.get(0));                    //商家姓名 要改的
//                            shangjiaEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            shangjiaEntity.setShangjiaPhoto("");//详情和图片
//                            shangjiaEntity.setShangjiaIdNumber(data.get(0));                    //身份证号 要改的
//                            shangjiaEntity.setShangjiaPhone(data.get(0));                    //联系方式 要改的
//                            shangjiaEntity.setShangjiaEmail(data.get(0));                    //电子邮箱 要改的
...
//                            shangjiaEntity.setCreateTime(date);//时间
                            ...
                            //把要查询是否重复的字段放入map中
                                ...
                                //身份证号
                                if(seachFields.containsKey("shangjiaIdNumber")){
                                    List<String> shangjiaIdNumber = seachFields.get("shangjiaIdNumber");
                                    shangjiaIdNumber.add(data.get(0));//要改的
                                }else{
                                    List<String> shangjiaIdNumber = new ArrayList<>();
                                    shangjiaIdNumber.add(data.get(0));//要改的
                                    seachFields.put("shangjiaIdNumber",shangjiaIdNumber);
                                }
                                //联系方式
                        ...
                        if(shangjiaEntities_username.size() >0 ){
                         ...
                         //身份证号
                        List<ShangjiaEntity> shangjiaEntities_shangjiaIdNumber = shangjiaService.selectList(new EntityWrapper<ShangjiaEntity>().in("shangjia_id_number", seachFields.get("shangjiaIdNumber")).eq("shangjia_delete", 1));
                        if(shangjiaEntities_shangjiaIdNumber.size() >0 ){
                            ArrayList<String> repeatFields = new ArrayList<>();
                            for(ShangjiaEntity s:shangjiaEntities_shangjiaIdNumber){
                                repeatFields.add(s.getShangjiaIdNumber());
                            }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        String token = tokenService.generateToken(shangjia.getId(),username, "shangjia", "农家乐商家");
        R r = R.ok();
        r.put("token", token);
        r.put("role","农家乐商家");
