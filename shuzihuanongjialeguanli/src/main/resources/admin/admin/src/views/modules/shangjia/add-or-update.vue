    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="商家姓名" prop="shangjiaName">
                       <el-input v-model="ruleForm.shangjiaName"
                                 placeholder="商家姓名" clearable  :readonly="ro.shangjiaName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="商家姓名" prop="shangjiaName">
                           <el-input v-model="ruleForm.shangjiaName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangjiaPhoto" label="商家头像" prop="shangjiaPhoto">
                        <file-upload
                            tip="点击上传商家头像"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangjiaPhoto" label="商家头像" prop="shangjiaPhoto">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="身份证号" prop="shangjiaIdNumber">
                       <el-input v-model="ruleForm.shangjiaIdNumber"
                                 placeholder="身份证号" clearable  :readonly="ro.shangjiaIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="身份证号" prop="shangjiaIdNumber">
                           <el-input v-model="ruleForm.shangjiaIdNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="shangjiaEmail">
                       <el-input v-model="ruleForm.shangjiaEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.shangjiaEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="电子邮箱" prop="shangjiaEmail">
                           <el-input v-model="ruleForm.shangjiaEmail"
