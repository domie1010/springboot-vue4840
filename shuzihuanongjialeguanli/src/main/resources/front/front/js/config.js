...
var centerMenu = [
    ...
    ,{
        name: '活动报名',
        url: '../huodongYuyue/list.html'
    }
    ,{
        name: '客房收藏',
        url: '../minsuCollection/list.html'
    }
    ,{
        name: '客房预定',
        url: '../minsuOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/shuzihuanongjialeguanli/admin/dist/index.html#/login";
